...
class SelectVeterinaryScreenForUser extends ConsumerWidget {
  static const String routeName = '/select-veterinary-for-user';
  const SelectVeterinaryScreenForUser({super.key});
              ...
              return Card(
                ...
                child: ListTile(
                  onTap: () => Navigator.pushNamed(
                      context, CertificateListScreen.routeName,
